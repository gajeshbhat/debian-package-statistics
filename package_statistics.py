...
def run_cli():
    ...
    parser.add_argument("arch", type=str, default=config["DEFAULT_ARCH"], help="The architecture for which to retrieve the package statistics")
    parser.add_argument("-m", "--mirror", type=str, default=config["DEFAULT_MIRROR_URL"], help="The Debian mirror to use")
    parser.add_argument("-n", "--top", type=int, default=config["DEFAULT_TOP_N"], help="The number of top packages to retrieve")
